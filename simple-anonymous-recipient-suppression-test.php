...
// Posting a anonymous suppressed recipient to Emailbidding API and dumping the result

$wasRecipientSuppressedWithSuccess = false;
try {

    $wasRecipientSubmittedWithSuccess = $suppressedRecipientSuppression->post(
        array(SuppressedRecipientFactory::createSimpleAnonymousSuppressedRecipient('email@domain.com'),
            SuppressedRecipientFactory::createSimpleAnonymousSuppressedRecipient('email2@domain.com')),
        851,
        'my_best_database',
        Suppression::MD5_SUPPRESSION_TYPE
    );
